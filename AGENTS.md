...
- Laravel 11, PHP `^8.2`, Livewire 3, Jetstream 5, Fortify, Sanctum 4, MySQL.
...
- Keep PHP compatible with Laravel 11/PHP 8.2-era constraints unless the touched file already requires newer syntax.
...
- No more `app/Http/Kernel.php` or `app/Console/Kernel.php` (L11 uses `bootstrap/app.php`).
