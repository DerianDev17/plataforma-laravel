...
<body class="antialiased">
    ...
    <div class="app-shell">
        ...
        @persist('sidebar')
        <aside class="app-sidebar" data-sidebar role="navigation" aria-label="Navegacion principal" key="sidebar">
            ...
            <nav class="sidebar-nav" aria-label="Menu principal">
                <div class="sidebar-section">
                    ...
                    <a wire:navigate.hover href="{{ route('dashboard') }}" wire:current="active" class="sidebar-link">
                    ...
                    <a wire:navigate.hover href="{{ route('informacion') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                        </span>
                        Panel Informativo
                    </a>
                    <a wire:navigate.hover href="{{ route('dashboard-meetings') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                        </span>
                        Reuniones
                ...
                <div class="sidebar-section">
                    ...
                    <a wire:navigate.hover href="{{ route('dashboard-students') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4-4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
                        </span>
                        Estudiantes
                    </a>
                    <a wire:navigate.hover href="{{ route('users-crud') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4-4v2"/><circle cx="12" cy="7" r="4"/></svg>
                        </span>
                        Usuarios
                    </a>
                    <a wire:navigate.hover href="{{ route('asistencias-crud') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                        </span>
                        Asistencias
                    </a>
                    <a wire:navigate.hover href="{{ route('sesiones-crud') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        </span>
                        Sesiones
                    </a>
                    <a wire:navigate.hover href="{{ route('admin.activity') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 013 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>
                        </span>
                        Actividad
                    </a>
                    <a wire:navigate.hover href="{{ route('live-class-provider') }}" class="sidebar-link {{ request()->routeIs('live-class-provider') || request()->routeIs('zoom-configuration') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                    ...
                    <a wire:navigate.hover href="{{ route('actualizar_base.get') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                ...
                <div class="sidebar-section">
                    ...
                    <a wire:navigate.hover href="{{ route('drives') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                ...
                <div class="sidebar-section">
                    ...
                    <a wire:navigate.hover href="{{ route('course_programm') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                ...
                <div class="sidebar-section">
                    ...
                    <a wire:navigate.hover href="{{ route('dashboard-asistencias') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                        </span>
                        Mis asistencias
                    </a>
                    <a wire:navigate.hover href="{{ route('recursos') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
                    ...
                    <a wire:navigate.hover href="{{ route('material_digital') }}" wire:current="active" class="sidebar-link">
                        <span class="sidebar-icon" aria-hidden="true">
        ...
        <main class="app-main" id="main-content">
            <header class="app-topbar">
                ...
                <div class="topbar-right">
                    <a wire:navigate.hover href="{{ route('profile.show') }}" class="eus-btn eus-btn-ghost eus-btn-icon" aria-label="Perfil de usuario" title="Perfil">
            ...
            <div class="page-content" wire:loading.class="page-content--loading">
                <div wire:loading class="page-skeleton" aria-hidden="true">
                    <div class="skeleton-bar skeleton-bar--title"></div>
                    <div class="skeleton-bar skeleton-bar--text"></div>
                    <div class="skeleton-bar skeleton-bar--text skeleton-bar--short"></div>
                </div>
                {{ $slot }}
            </div>
        </main>
