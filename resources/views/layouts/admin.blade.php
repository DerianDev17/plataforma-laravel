        ...
        <aside class="app-sidebar" data-sidebar role="navigation" aria-label="Navegacion principal">
            ...
            <nav class="sidebar-nav" aria-label="Menu principal">
                <div class="sidebar-section">
                    ...
                    <a href="{{ route('informacion') }}" class="sidebar-link {{ request()->routeIs('informacion') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                ...
                <div class="sidebar-section">
                    ...
                    <a href="{{ route('dashboard-students') }}" class="sidebar-link {{ request()->routeIs('dashboard-students') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4-4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
                        </span>
                        Estudiantes
                    </a>
                    <a href="{{ route('users-crud') }}" class="sidebar-link {{ request()->routeIs('users-crud') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4-4v2"/><circle cx="12" cy="7" r="4"/></svg>
                        </span>
                        Usuarios
                    </a>
                    <a href="{{ route('asistencias-crud') }}" class="sidebar-link {{ request()->routeIs('asistencias-crud') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                        </span>
                        Asistencias
                    </a>
                    <a href="{{ route('sesiones-crud') }}" class="sidebar-link {{ request()->routeIs('sesiones-crud') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        </span>
                        Sesiones
                    </a>
                    <a href="{{ route('zoom-configuration') }}" class="sidebar-link {{ request()->routeIs('zoom-configuration') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                    ...
                    <a href="{{ route('get.register_participants') }}" class="sidebar-link {{ request()->routeIs('get.register_participants') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                    ...
                    <a href="{{ route('actualizar_base.get') }}" class="sidebar-link {{ request()->routeIs('actualizar_base.get') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                ...
                <div class="sidebar-section">
                    ...
                    <a href="{{ route('drives') }}" class="sidebar-link {{ request()->routeIs('drives') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                ...
                <div class="sidebar-section">
                    ...
                    <a href="{{ route('course_programm') }}" class="sidebar-link {{ request()->routeIs('course_programm') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                ...
                <div class="sidebar-section">
                    ...
                    <a href="{{ route('dashboard-asistencias') }}" class="sidebar-link {{ request()->routeIs('dashboard-asistencias') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                        </span>
                        Mis asistencias
                    </a>
                    <a href="{{ route('recursos') }}" class="sidebar-link {{ request()->routeIs('recursos') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
                    ...
                    <a href="{{ route('material_digital') }}" class="sidebar-link {{ request()->routeIs('material_digital') ? 'active' : '' }}">
                        <span class="sidebar-icon" aria-hidden="true">
